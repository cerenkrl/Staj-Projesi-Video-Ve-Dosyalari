...
namespace Kutuphane_Otomasyon_Sistemi
{
    public partial class FormIstatistik : Form
    {
        ...
        void istatistikGor()
        {
            ...
            {
                case 0:
                    query = "select adi+' '+soyadi as X, COUNT(*) as Y  from emanetler inner join okuyucular on okuyucular.id = emanetler.okuyucuId where okuyucular.aktif = 1 and" +
                        " emanetler.aktif = 1 group by adi+' '+soyadi";
                    break;
        ...
        private void cbbIstatistik_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            istatistikGor();
        }
    }
